...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES(:BookingNumber,:useremail,:vhid,:fromdate,:todate,:message,:status)";
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>&#8377 <?php echo htmlentities($result->PricePerDay);?> </p>Per Day
...
function validateCarBookForm(){
  ...
  var enteredTime = $("#fromtime").val().split(":");
  var enteredHour = enteredTime[0];
  var enteredMin = enteredTime[1];
...
// if(today== new date)
  ...
  if(enteredHour >= currentHour && enteredMin >= currentMin){
    return true;
  } 
