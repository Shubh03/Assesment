    ...
    if ( $query->rowCount() > 0 ) {
        foreach ( $results as $result ) {
            ...
            ?> Booking Details </h3>
                                            ...
                                            <tr>
                                                <th colspan="4" style="color:blue">
                                                    <img src="../uploads/<?php echo htmlentities($result->Vimage1);?>"
                                                        class="out-img"  /> </th>
                                            ...
                                            <tr>
                                                ...
                                                <td>#<?php echo htmlentities( $result->BookingNumber );
            ?>

                                                </td>
                                                <th>Name</th>
                                                <td><?php echo htmlentities( $result->FullName );
            ?></td>
                                            </tr>
                                            <tr>
                                                <th>Email Id</th>
                                                <td><?php echo htmlentities( $result->EmailId );
            ?></td>
                                                <th>Contact No</th>
                                                <td><?php echo htmlentities( $result->ContactNo );
            ?></td>
                                            </tr>
                                            <tr>

                                                <th>DL_NO</th>
                                                <td><?php echo htmlentities( $result->DL_NO );
            ?></td>
            ...
            ?></td>
                                            ...
                                            <tr>
                                                <th>City</th>
                                                <td><?php echo htmlentities( $result->City );
            ?></td>
                                                <th>Country</th>
                                                <td><?php echo htmlentities( $result->Country );
            ?></td>
            ...
            ?></td>
                                            ...
                                            <tr>
                                                <th>From Date</th>
                                                <td><?php echo htmlentities( $result->FromDate );
            ?></td>
                                                <th>To Date</th>
            ...
            ?></td>
                                                <th>Rent Per Days</th>
                                                <td><?php echo htmlentities( $ppdays = $result->PricePerDay );
            ?></td>
                                            </tr>
                                            <tr>
                                                <th colspan="3" style="text-align:center">Grand Total</th>
                                                <td><?php echo htmlentities( $tdays*$ppdays );
            ?></td>
                                            </tr>
                                            <tr>
            ...
            ?></td>
                                                ...
                                                <td><?php echo htmlentities( $result->LastUpdationDate );
            ?></td> -->
                                            </tr>
